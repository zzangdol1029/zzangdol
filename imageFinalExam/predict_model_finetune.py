...
if __name__ == "__main__":
    ...
    # 예측에 사용할 모델 파일명을 2025254011_ft.h5로 고정
    model_path = os.path.join(os.path.dirname(__file__), f"{student_id}_ft.h5")
    image_list = ["1.png", "2.png", "6.png", "9.png"]
    for image_name in image_list:
        image_path = os.path.join(os.path.dirname(__file__), image_name)
        # 출력 파일명을 1_ft.txt, 2_ft.txt, ... 형식으로 저장
        output_path = os.path.join(os.path.dirname(__file__), f"{image_name.split('.')[0]}_ft.txt")
